...
Extra Information:
    ...
    'Number of Staff' metric will only track accounts that have staff mode ONLY. So accounts that have staff mode AND,
    admin mode enabled will count as an admin account.
